...
import PaymentButton from "./StripePayment";

export const Details = () => {
  const handleClick = () => {
    // Show a toast notification for 5 seconds indicating the start of processing
    toast.info("Processing the payment", { duration: 5000, theme: "dark" });

    setTimeout(() => {
      // Show a success toast message
      toast.success("Payment processing complete!", { theme: "dark" });
    }, 6000);
    <PaymentElement />;
  };
            ...
            <div className="details_content">
              ...
              <div className="details_content_detail">
                ...
                <div className="qty">
                  ...
                  <PaymentButton amount={item.price * item.qty * 100} />
                  <ToastContainer position="top-center" />
                </div>
                <div className="desc">
                  <h4>PRODUCTS DESCRIPTION</h4>
                  <p style={{ fontFamily: "fantasy", fontSize: "60px" }}>
